        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <a href="{{route('show7')}}"><button type="submit" class="btn btn-primary">Update category Title</button></a>
                           ...
                           <tr style="text-transform: capitalize;">
                              ...
                              <tr>
                                 ...
                                 <td>{{$d->id}}</td>
                                  <td>{{$d->name}}</td>
                                   <td> 
                                     <form action="{{ route('category.destroy',$d->id) }}"
                                     method="Post">
                                       <a class="btn btn-primary"
                                        href="{{ route('category.edit',  $d->id) }}">Edit</a>
                                           @csrf
                                             @method('DELETE')
