                            ...
                            <div class="col-md-6">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Product CAS No" name="product_cas_no" value="{{$product->product_cas_no}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="product">Status</label>
                                        <input type="text" class="form-control" placeholder="Enter Product Status" name="status" value="{{$product->status}}">
                                    </div>
                                    <br>
