        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <a href="{{route('brands.create')}}"><button type="submit" class="btn btn-primary">Add Brands</button></a>
                    </div>
                       ...
                       <thead>
                           <tr style="text-transform: capitalize;">
                              ...
                              <tr>
                                 @foreach($data as $d)
                                 <td>{{$d->id}}</td>
                                  <td><img src="{{ asset('/Backend/images/brands/'.$d->image) }}" alt="Image" title="Image" width="150px" height="150px" style="background-color: black;"></td>
                                   <td> 
                                     <form action="{{ route('brands.destroy',$d->id) }}"
                                     method="Post">
                                       <a class="btn btn-primary"
                                        href="{{ route('brands.edit',  $d->id) }}">Edit</a>
                                           @csrf
                                             @method('DELETE')
