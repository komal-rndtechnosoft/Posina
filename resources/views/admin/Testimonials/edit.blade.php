                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h3 class="m-b-10">Update Testimonials</h3>
                        </div>
                        <ul class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form id="main" action="{{route('testimonials.update', $data->id)}}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="designation"
                                                placeholder="Sub-Title" value="{{ $data->designation }}">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="img-fluid card-img-top" style="height: 100px; width: 100px;"
                                                src="{{ asset('Backend/images/testimonial/' . $data->image) }}"
                                                alt="Image"><br><br>
