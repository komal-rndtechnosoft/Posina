        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <a href="{{route('Certificate.create')}}"><button type="submit" class="btn btn-primary">Add Certificate</button></a>
                    <a href="{{route('show6')}}"><button type="submit" class="btn btn-primary">Update Certificate Title</button></a>
                                   ...
                                   <td> 
                                     ...
                                     method="Post">
                                       <a class="btn btn-primary"
                                        href="{{ route('Certificate.edit',  $d->id) }}">Edit</a>
                                           @csrf
                                             @method('DELETE')
