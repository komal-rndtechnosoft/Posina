                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('usp')}}">USP</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <a href="{{route('usp.create')}}"><button type="submit" class="btn btn-primary">Add USP</button></a>
                    <a href="{{route('show1')}}"><button type="submit" class="btn btn-primary">Update USP Title</button></a>
                           ...
                           <tr style="text-transform: capitalize;">
                              ...
                              <tr>
                                 ...
                                 <td>{{$d->id}}</td>
                                  <td>{{$d->title}}</td>
                                   <td> 
                                     <form action="{{ route('usp.destroy',$d->id) }}"
                                     method="Post">
                                       <a class="btn btn-primary"
                                        href="{{ route('usp.edit',  $d->id) }}">Edit</a>
                                           @csrf
                                             @method('DELETE')
