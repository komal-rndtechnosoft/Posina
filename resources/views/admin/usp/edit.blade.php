    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{url('usp')}}"><button type="submit" class="btn btn-primary">Back</button></a>
                        <h3>Update usp</h3>
                        <div class="row">
                            <div class="col-md-6">
                            <form id="main" action="{{route('usp.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="img-fluid card-img-top"
                                                ...
                                                src="{{ asset('Backend/images/usp/' . $data->icon) }}"
