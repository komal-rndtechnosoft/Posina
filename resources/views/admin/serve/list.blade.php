        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <a href="{{route('serve.create')}}"><button type="submit" class="btn btn-primary">Add Industry We Serve</button></a>
                    <a href="{{route('show3')}}"><button type="submit" class="btn btn-primary">Update Industry We Serve Title</button></a>
                           ...
                           <tr style="text-transform: capitalize;">
                              ...
                              <tr>
                                 ...
                                 <td>{{$d->id}}</td>
                                  <td>{{$d->title}}</td>
                                   <td> 
                                     <form action="{{ route('serve.destroy',$d->id) }}"
                                     method="Post">
                                       <a class="btn btn-primary"
                                        href="{{ route('serve.edit',  $d->id) }}">Edit</a>
                                           @csrf
                                             @method('DELETE')
