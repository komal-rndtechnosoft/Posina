                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h3 class="m-b-10">Add Serve</h3>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('home')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{url('serve')}}">Industry We Serve</a></li>
                            <li class="breadcrumb-item"><a href="#!">Create Industry We Serve</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <a href="{{url('serve')}}"><button type="submit" class="btn btn-primary">Back</button></a>
                        ...
                        <div class="row">                  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="alt_tag1" id="p_name" placeholder="Enter Alt Tag" required>
                                    <span class="messages"></span>
                                </div>
                            </div>
