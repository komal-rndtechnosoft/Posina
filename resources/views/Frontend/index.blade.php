...
$product = DB::table('products')->select('*')->latest()->first();
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="exampleModalLabel">Our Latest Product</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<img src="{{ asset('/Backend/images/product/' . $product->image) }}" alt="Card image cap"
					style="width: 100%;">
		...
		<div class="row align-items-center mb-20">
			<div class="col-lg-6">
				<div class="about__img__wrapper mb-30">
					<img class="about__img__3c" src="{{ asset('Backend/images/about/' . $about->image) }}"
						alt="{{$about->alt_tag}}" style="object-fit:cover;">
	...
	<div class="row justify-content-center">
		<div class="col-lg-7">
			<div class="section__title text-center mb-30">
				<h4 class="sub__title__three mb-25">Our Brands</h4>
				<h2 class="section__title__one">Our Brands</h2>
			</div>
		</div>
	</div>
			...
			@foreach($brands as $b)
				<div class="swiper-slide">
					<div class="brand__img__two">
						<a><img src="{{ asset('Backend/images/brands/' . $b->image) }}" alt="{{$b->alt_tag}}"
								style="width:85px;"></a>
					</div>
				</div>
			@endforeach
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-7 col-lg-6">
					<div class="chose__img__wrapper text-center text-lg-end mb-30">
						...
						<img class="main__img__3c" src="{{ asset('Backend/images/about/' . $whoweare->image) }}"
							alt="{{$whoweare->alt_tag}}">
						<img class="main__img__4c d-none d-xl-inline-block"
							src="{{ asset('Backend/images/about/' . $whoweare->image1) }}"
					...
					<div class="col-lg-4 col-md-6">
						<div class="blog__one mb-30 bloo">
							...
							<div class="blog__content__one">
								...
								<h3 class="blog__title__three"><a
										href="{{url('/blogdetails/' . $b->slug)}}">{{$b->title}}</a>
								</h3>
